...
selected_member.borrowed_books.append(book)
                    print(f"The book '{book.name}' has been borrowed on {book.borrow_date} by {selected_member.name}")
        ...
        for book in selected_member.borrowed_books:
            if name == book.name:
                if not book.available:
                    ...
                    book.available = True
                    print(f"The book '{book.name}' has been returned on {book.return_date}")
        ...
        for book in cls.all_books:
            if name == book.name:
                ...
                if book.available:
                    ...
                    print(f"The book is currently being borrowed and will be returned on {book.return_date}")
...
class Member:
      ...
      def __init__(self,name,member_id):
          ...
          self.borrowed_books = [] Member.all_members.append(self)
     def show_details(self):
         print("\n Member details:")
